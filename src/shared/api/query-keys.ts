...
export const auctionKeys = {
  ...
  /**
   * Префикс всех вариантов списка — любые фильтры, любая страница.
   *
   * Нужен инвалидации после ставки (8.4): цена и место в рейтинге меняются у
   * аукциона, который может быть виден под любым набором фильтров, а какой
   * именно применён у пользователя прямо сейчас, мутация не знает.
   * @returns Ключ-префикс, под который попадают все запросы списка.
   */
